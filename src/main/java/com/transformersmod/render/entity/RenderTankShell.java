...
import com.transformersmod.model.ModelTankShell;
...
public class RenderTankShell extends Render
{
     ...
     */
    public void doRender(EntityTankShell tankShell, double x, double y, double z, float p_76986_9_)
    {
		GL11.glPushMatrix();
    ...
    {
        this.doRender((EntityTankShell)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_9_);
    }
}