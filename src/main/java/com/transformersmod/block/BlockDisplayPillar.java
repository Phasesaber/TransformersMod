...
import com.transformersmod.item.ItemMiniVehicle;
...
public class BlockDisplayPillar extends BlockBasic implements ITileEntityProvider
{
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int metadata)
	{
		...
		super.breakBlock(world, new BlockPos(x, y, z), block.getDefaultState());
	}

	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		TileEntityDisplayPillar tileEntityDisplayPillar = (TileEntityDisplayPillar) world.getTileEntity(new BlockPos(x, y, z));
	...
	public MovingObjectPosition collisionRayTrace(World world, int x, int y, int z, Vec3 p_149731_5_, Vec3 p_149731_6_)
	{
		...
		return super.collisionRayTrace(world, new BlockPos(x, y, z), p_149731_5_, p_149731_6_);
	}
