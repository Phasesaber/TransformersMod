...
public class EntityTankShell extends EntityArrow implements IProjectile
{
	...
	public void onUpdate()
	{
		...
		if (this.inGround)
		{
			int j = this.worldObj.getBlockState(new BlockPos(this.blockX, this.blockY, this.blockZ)).getBlock().getMetaFromState(this.worldObj.getBlockState(new BlockPos(this.blockX, this.blockY, this.blockZ)));
		...
		else
		{
			...
			if (movingobjectposition != null)
			{
				...
				else
				{
					...
					this.hitBlock = this.worldObj.getBlockState(new BlockPos(this.blockX, this.blockY, this.blockZ)).getBlock();
					this.inData = this.worldObj.getBlockState(new BlockPos(this.blockX, this.blockY, this.blockZ)).getBlock().getMetaFromState(this.worldObj.getBlockState(new BlockPos(this.blockX, this.blockY, this.blockZ)));
					...
					{
						this.hitBlock.onEntityCollidedWithBlock(this.worldObj, new BlockPos(this.blockX, this.blockY, this.blockZ), this);
					}
				}
			}
