package com.transformersmod.config;
...
public class TFConfig
{
	...
	public void load(Configuration config)
	{
		...
		useMiles = config.getBoolean("Use Miles For Speed-Measurement", "Options", false, "If true, miles will be used instead of kilometers when measuring speed.");
	}
}